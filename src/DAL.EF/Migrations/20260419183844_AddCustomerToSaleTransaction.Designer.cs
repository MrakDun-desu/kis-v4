...
namespace KisV4.DAL.EF.Migrations
{
    ...
    [Migration("20260419183844_AddCustomerToSaleTransaction")]
    partial class AddCustomerToSaleTransaction
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.AuditLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.LayoutItem", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("LayoutItem");
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.Modification", b =>
                {
                    ...
                    b.Property<int>("SaleTransactionItemLineNumber")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("ModifierId", "SaleTransactionItemLineNumber", "SaleTransactionId");

                    b.HasIndex("SaleTransactionItemLineNumber", "SaleTransactionId");
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.PriceChange", b =>
                {
                    ...
                    b.Property<int?>("SaleTransactionItemSaleTransactionId")
                        .HasColumnType("integer");

                    b.HasKey("DiscountUsageId", "SaleTransactionItemId");

                    b.HasIndex("SaleTransactionItemLineNumber", "SaleTransactionItemSaleTransactionId");
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.SaleTransactionItem", b =>
                {
                    ...
                    b.HasKey("LineNumber", "SaleTransactionId");
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.Tap", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.User", b =>
                {
                    ...
                    b.Property<bool>("GamificationAllowed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.LayoutTap", b =>
                {
                    b.HasBaseType("KisV4.DAL.EF.Entities.LayoutItem");
                    ...
                    b.ToTable("LayoutItems", t =>
                        {
                            t.Property("TargetId")
                                .HasColumnName("LayoutTap_TargetId");
                        });

                    b.HasDiscriminator().HasValue("LayoutTap");
                });
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.Modification", b =>
                {
                    ...
                    b.HasOne("KisV4.DAL.EF.Entities.SaleTransactionItem", "SaleTransactionItem")
                        .WithMany("Modifications")
                        .HasForeignKey("SaleTransactionItemLineNumber", "SaleTransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.PriceChange", b =>
                {
                    ...
                    b.HasOne("KisV4.DAL.EF.Entities.SaleTransactionItem", "SaleTransactionItem")
                        .WithMany("PriceChanges")
                        .HasForeignKey("SaleTransactionItemLineNumber", "SaleTransactionItemSaleTransactionId");
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.Tap", b =>
                {
                    b.HasOne("KisV4.DAL.EF.Entities.Container", "Container")
                        .WithOne("Tap")
                        .HasForeignKey("KisV4.DAL.EF.Entities.Tap", "ContainerId")
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.CashBoxAccount", b =>
                {
                    b.HasOne("KisV4.DAL.EF.Entities.Cashbox", "Cashbox")
                        .WithOne("Account")
                        .HasForeignKey("KisV4.DAL.EF.Entities.CashBoxAccount", "CashboxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.UserAccount", b =>
                {
                    b.HasOne("KisV4.DAL.EF.Entities.User", "User")
                        .WithOne("Account")
                        .HasForeignKey("KisV4.DAL.EF.Entities.UserAccount", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.LayoutTap", b =>
                {
                    b.HasOne("KisV4.DAL.EF.Entities.Tap", "Target")
                        .WithMany()
                        .HasForeignKey("TargetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KisV4.DAL.EF.Entities.SaleTransaction", b =>
                {
                    b.HasOne("KisV4.DAL.EF.Entities.User", "Customer")
                        .WithMany()
                    ...
                    b.HasOne("KisV4.DAL.EF.Entities.User", null)

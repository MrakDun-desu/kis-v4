        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarginPercent = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false),
                    MarginStatic = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false),
                    PrestigeAmount = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentCost = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GamificationAllowed = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_Cashboxes_CashboxId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<int>(type: "integer", nullable: false),
                    Cancelled = table.Column<bool>(type: "boolean", nullable: false),
                    BasePrice = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemAmount = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false),
                    Cost = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false),
                    Cancelled = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NewAmount = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Taps_Containers_ContainerId",
                        column: x => x.ContainerId,
                        principalTable: "Containers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Taps_Stores_StoreId",
                        column: x => x.StoreId,
                        principalTable: "Stores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SaleTransactionId = table.Column<int>(type: "integer", nullable: false),
                    Amount = table.Column<int>(type: "integer", nullable: false),
                    PriceChange = table.Column<decimal>(type: "numeric(13,4)", precision: 13, scale: 4, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LayoutTap_TargetId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LayoutItems_Taps_LayoutTap_TargetId",
                        column: x => x.LayoutTap_TargetId,
                        principalTable: "Taps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LayoutItems_LayoutTap_TargetId",
                table: "LayoutItems",
                column: "LayoutTap_TargetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Taps_ContainerId",
                table: "Taps",
                column: "ContainerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Taps_StoreId",
                table: "Taps",
                column: "StoreId");

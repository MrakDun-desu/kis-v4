...
```typescript
import type { StoreTransactionCreateResponse } from ''
...
} satisfies StoreTransactionCreateResponse
...
const exampleParsed = JSON.parse(exampleJSON) as StoreTransactionCreateResponse
